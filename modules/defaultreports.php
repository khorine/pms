...
elseif($reportpost==='fetchaccountstatement'){
    ...
    ?>
   <table class="treport" ><thead>
           <tr><td><img src="../images/cursors/anjuman.png" style="height:50px;width:70px;"></td><td colspan="7" style="background-color:beige"><h3><center>BANK STATEMENT FOR <i><?php echo $accountdetails[0]['acname']; ?></i> &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($fromdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($todate)) ?></center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
   <th><center><u>Date</u></center></th>
<th><center><u>Recp/Pay No</u></center></th>
<th><center><u>Mode</u></center></th>
    <th><center><u>Cheque No</u></center></th>
<th><center><u>Cheque Date</u></center></th>
...
foreach ($statements as $statement) {
        ...
        }else{$date=date("d-m-Y",strtotime($statement['paydate']));
...
<table class="treport" ><thead>
        ...
        <tr><td><b>#</b></td><td><b>Tenant</b></td><td><b>Tenant Phone</b></td><td><b>Tenant Email</b></td><td><b>Building</b></td><td><b>Apartment/Suite</b></td><td><b>Lease From</b></td><td><b>Lease To</b></td><td><b>Lease Document</b></td></tr>      
    </thead>
    <tbody>
      <?php
      $count=1;
...
elseif($reportpost==='depositrefundlist'){ 
   ...
   $deposits=getDepositRefundList($startdate, $enddate, $propid);
    ?>
  <table class="treport" ><thead>
           <tr><td><img src="../images/cursors/anjuman.png" style="height:50px;width:70px;"></td><td colspan="9" style="background-color:beige"><h3><center>DEPOSIT REFUND STATEMENT  <i><?php echo $accountdetails[0]['acname']; ?></i> &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($startdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($enddate)) ?></center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
   <th><center><u>Date</u></center></th>
<th><center><u>Pay No</u></center></th>
<th><center><u>Mode</u></center></th>
    <th><center><u>Cheque No</u></center></th>
<th><center><u>Cheque Date</u></center></th>
...
<?php
   ...
   foreach ($deposits as $deposit) { 
      ...
      <tr><td><?php echo $count; ?></td><td><?php echo date("d-m-Y",  strtotime($deposit['paydate'])); ?></td><td><?php echo $deposit['payno']; ?></td><td><?php echo $deposit['pmode']; ?></td><td><?php echo $deposit['chqno']; ?></td><td><?php echo $deposit['chequedate']; ?></td><td><?php echo $deposit['pmode']; ?></td><td><?php echo $tenantdetails['name']; ?></td><td><?php echo $deposit['amount']; ?></td></tr>
...
elseif($reportpost=='fetchstatement'){
    ...
    echo fetchstatement($tenantid,$propid,$startdate,$enddate,$count,$allpropertiesflag='F');
         }
}
...
elseif($reportpost=='commissionlist'){
    $startdate=htmlspecialchars($_REQUEST['startdate']);
     ...
     ?>
<table class="treport" ><thead>
        <tr><td><img src="../images/cursors/anjuman.png" style="height:50px;width:70px;"></td><td colspan="4" style="background-color:beige"><h3><center>COMMISSIONS LIST &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($startdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($enddate)) ?></center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
<th><center><u>Property</u></center></th>
<th><center><u>Total Rent</u></center></th>
<th><center><u>Commission</u></center></th>
<th><center><u>Commission Amount</u></center></th></tr></thead><tbody>
   <?php
...
<table class="treport exportlist" ><thead>
        <tr><td><img src="../images/cursors/anjuman.png" style="height:50px;width:70px;"></td><td colspan="7" style="background-color:beige"><h3><center>VACANCY REPORT</center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
<th><center><u>Property Name</u></center></th>
<th><center><u>Vacancies</u></center></th>
 ...
 foreach ($allproperties as $property) { 
    ...
    <tr><td><?=$count?></td><td><?=$property["property_name"]?></td><td><?php foreach ($vacants as $value) {
...
<?php }
elseif($reportpost=='accounttransactions'){
      $startdate=htmlspecialchars($_REQUEST['fromdate']);
  ...
  $transactions=getBankTransactions($startdate, $enddate,$account);
    ?>
<table class="treport exportlist" ><thead>
        <tr><td><img src="../images/cursors/anjuman.png" style="height:50px;width:70px;"></td><td colspan="7" style="background-color:beige"><h3><center>INTERNAL BANK TRANSACTIONS  &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($startdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($enddate)) ?></center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
<th><center><u>Recp/PayNo</u></center></th>
<th><center><u>Account</u></center></th>

<th><center><u>Amount</u></center></th>
<th><center><u>Date/Time</u></center></th>
<th><center><u>Credit/Debit</u></center></th>
<th><center><u>Narration</u></center></th>
<th><center><u>Transacted By</u></center></th>
</tr>
</thead><tbody>
    <?php
    $count=1;
    ...
    foreach ($transactions as $transaction) {
        if($transaction["is_debit"]){$creditdebit="D";
...
<tfoot>
    <tr><td>ZTOTAL</td><td></td><td></td><td><?=  number_format($totalcredits+$totaldebits)?></td><td></td><td></td><td></td><td></td></tr>

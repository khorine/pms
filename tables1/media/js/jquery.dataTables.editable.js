    ...
    $.fn.makeEditable = function (options) {
        ...
        function _fnDeleteRow(id, sDeleteURL) {
            ...
            if (sDeleteURL == null){
                ...
                console.log("I have set the post url to "+sURL);}
            properties.fnStartProcessingMode();
            console.log("Checking this function (_fnDeleteRow).");
        ...
        function _fnOnRowDelete(event) {
            iDisplayStart = _fnGetDisplayStart();
            console.log("The delete button has been clicked Function Name (_fnOnRowDelete)");
        ...
        function _fnOnRowDeleted(response) {
            ...
            var regex = /success/i;
            var regexx = /ok/i;
            if (regex.test(response) || regexx.test(response)) {
				console.log("The record was deleted from the server. Function Name (_fnOnRowDeleted)");
				...
				console.log("The record was not successfully deleted from the server");
        ...
        */
        ...
        var defaults = {
            ...
            sUpdateURL: "./j/UpdateData.php",
            sAddURL: "./j/AddData",
            sDeleteURL: "./j/DeleteData.php",
        ...
        return this.each(function () {
            ...
            if (oDeleteRowButton.length != 0){
				console.log("The Delete button has been drawn");

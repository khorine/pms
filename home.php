...
$("#confpassword").change(function(e){
    ...
    }else{ $(".validateTips1").html("<font size='2' color='red'><center>Passwords do not match!</center></font>");}
...
<?php if(@$_REQUEST['error']){echo '<center>'.@$_REQUEST['error'].'</center>'; }
echo '<h3>'.$wheat.$spacer.$logopath.$property['company_name'].' | Property Manager |&nbsp;<div id="loggedin">'.$loggedin.' '.$admin.' | '.$clock.' '.$time.'</div>';?>
<?php
...
</select>  <input type="text" class="ui-widget-content ui-autocomplete-input" placeholder="Tenant Name" id="tenantnamesearch"> 
<input type="text" placeholder="House No" class="ui-widget-content ui-autocomplete-input" id="housenosearch"> <input type="submit" id="searchtenant" class="text ui-widget-content ui-corner-aEll"  value="Search">
...
<!-- add agent-->
  <div id="formregisteragent" title="Register User">
	...
	<fieldset>
            <table>                                                   
                             <tr><td><label for="agentname"><u>User Name</u> &nbsp;</label></td>
		<td><input id='agentname' type="text" name='agentname'  style="width:300px;">
                        </td></tr>  
                                <tr><td><label for="agentpassword"><u>User Password</u> &nbsp;</label></td>
		<td><input id='agentpassword' type="password" name='agentpassword'  style="width:300px;">
                        </td></tr>
                                <tr><td><label for="usergroup"><u>User Group</u> &nbsp;</label></td>
		<td><select id='usergroup' type="text" name='usergroup'  style="width:300px;">
                ...
                <tr><td><label for="agentphone"><u>Phone</u> &nbsp;</label></td>
		<td><input id='agentphone' type="text" name='agentphone'  style="width:300px;">
                        </td></tr>  
		<tr><td><label for="address"><u>Address</u> &nbsp;</label></td>
                    <td><input id='agentaddress' type="text" value="n/a" name='address'  style="width:300px; height:40px;">
                        </td></tr>  
                <tr><td></td><td><input type="submit" id="btnregister"  class="text ui-widget-content ui-corner-all" value="REGISTER USER" style="width:200px;font-weight:bold;"/></td></tr>
            </table>
	</fieldset>
	</form>
</div>
...
<!-- assign agent to property-->
  <div id="assignagent" title="Assign User Property">
	...
	<fieldset>
            <table>       
                <tr><td><label for="usergroup"><u>User Name</u> &nbsp;</label></td><td><label><u>Property Name</u> &nbsp;</label></td></td></tr>
                    <tr><td><select id='agentassignname' type="text" name='agentassignname'  style="width:200px;">
		...
		<td><select id='propertyassignname' type="text" name='propertyassignname'  style="width:200px;">
                    ...
                    <input id='commission' type="hidden" value="0" name='commission'  style="width:80px;"></tr>  
		                
           <tr> <td><label for="usergroup"><u>Assign All Properties ?</u> &nbsp;</label></td>
            <td><input id='allproperties' type="checkbox" name='allpropertiescheck'  style="width:80px;">
                        </td><br/></tr>
                
                <tr><td></td><td><input type="submit" id="btnassignagent"  class="text ui-widget-content ui-corner-all" value="ASSIGN PROPERTY" style="width:200px;font-weight:bold;"/></td></tr>
            </table>
	</fieldset>
	</form>
</div>

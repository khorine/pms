...
$("#chequedate").css("display","none"); $("#cheqno").css("display","none");$("#chequedetails").css("display","none");$("#chequedaterecp").css("display","none");$("#chequenorecp").css("display","none");$("#chequedetailsrecp").css("display","none");
...
});var consump;var lastreading; var totalwater; var aptid; var rentamount;
var itemsarray=[];var oldcount=[]; var sum=0; var total1=0;
...
$("#tenantnameinvoice").change(function(e){
    ...
    var totalvat=0; var housevat=0; var total =0;
...
$("#chargeitems").load("../modules/accountsprocess.php?chargeitems=true"+"&propid="+<?php echo $_SESSION['propertyid']?>, function(data) {
   ...
   var itemid;
       ...
       $(".chargeitem").change(function(e){  
                     ...
                     $(this).attr("readonly",true); $(this).attr("style","border:1px solid green");
                oldcount.push(count); 
    ...
    return currentValue + previousValue;
       ...
       var counter1=0; var k=1; var chargeamountarray=[]; var accountarray=[];var total=0;
...
$('#invoiceform')[0].reset();$("input[type='text']").attr("style","border:1px solid orange");//reset border color
...
$(".validateTips4").html("<font size='2' color='red'><center>All fields required!</center></font>");
  ...
  type: "POST",
  contentType: "application/json; charset=utf-8",
  url:"../modules/accountsprocess.php?batchinvoice=true&invoicedate="+$("#batchinvoicedate").val()+"&incomeaccount="+$("#batchincomeacct").val()+"&billing="+$("#batchinvoiceform input[type='radio']:checked").val()+"&amount="+$('#batchamount').val()+"&remarks="+$("#batchremarks").val()+"&fperiod="+$("#fperiodbatch option:selected").val()+"&propid="+<?php echo $_SESSION['propertyid']?>,
  data: "{}",
  dataType: "json"
})
...
$(".radio1").prop('disabled',false);$(".radio2").prop('disabled',false);
...
.done(function(data) {
        $("#caddress").val(data.address);$("#cemail").val(data.email);$("#ccity").val(data.city);$("#cphone").val(data.phone);
})
.fail(function() {
...
$("#chequedaterecp").datepicker({ changeMonth: true,changeYear: true});
...
//   echo "<option value='".$penaltygl['glcode']."' >" . htmlspecialchars($penaltygl['acname']) . "</option>";?>//"+"</select>");
 ...
 $("#recepdetails").load("../modules/accountsprocess.php?recpdetails=true&tenantid="+$("#tenantnamereceipt").val(), function(data) {
            ...
            a=id.split("&");
            var count;var oldcount=[];  var sum;
    ...
    return currentValue + previousValue;
                     ...
                     oldcount.pop();//remove last element
                      if(oldcount.length===0){sum=0;
                      }else{sum=oldcount.reduce(function(previousValue, currentValue){
    return currentValue + previousValue;
});} }                           
         $("#recpamount").val(sum);
                    });
 ...
 $("#recpamount").val(sum);
          ...
          var amountarray=[];  var invoicesarray=[];     
...
var  counter; var k=1;
 for (i=0;i<(a.length)-1;i++){
     if($("input[id='payamount"+a[i]+"']").val()>0){
        value=$("input[id='payamount"+a[i]+"']").val();amountarray.push(value);
        invoiceno=$("input[id='payamount"+a[i]+"']").attr("title");invoicesarray.push(invoiceno);
         counter=k++; //keep counter of items in array
     }
      }
      inv=JSON.stringify(invoicesarray);amt=JSON.stringify(amountarray);//change to php array
...
var penalize=1;
//apply penalty if not checked,default is not apply penalty
if($("#penalize:checkbox:checked").length>0){penalize=0;} 
 $.ajax({
  type: "POST",
  contentType: "application/json; charset=utf-8",
...
$("#paymoderecp").change(function(){
 ...
 if ($("#paymoderecp").val()==="1"||$("#paymoderecp").val()==="2"){
    $("#paymode option[value='1']").attr("selected", "selected"); $("#paymode option[value='0']").attr("disabled","disabled");//cheque enabled
    $("#chequedate").css("display","block"); $("#cheqno").css("display","block");$("#chequedetails").css("display","block");$("#chequedaterecp").css("display","block");$("#chequenorecp").css("display","block");$("#chequedetailsrecp").css("display","block");
...
//if cash
    ...
    $("#chequedate").css("display","none"); $("#cheqno").css("display","none");$("#chequedetails").css("display","none");$("#chequedaterecp").css("display","none");$("#chequenorecp").css("display","none");$("#chequedetailsrecp").css("display","none");
    $("#paymode option[value='0']").attr("selected", "selected"); $("#paymode option[value='1']").attr("disabled","disabled");//autoselect payment mode
 $("#accountsrecp").html("<select id='incomeacctrecp'  name='incomeacctrecp'  style='width:250px;'>"+
                "<?php  foreach ($incomegls as $value) {
   echo "<option value='".$value['acno']."' >" . htmlspecialchars($value['acname']) . "</option>";
}?>"
...
//if bank deposit
    ...
    echo "<option value='".$value['id']."' >" . htmlspecialchars($value['bank_name']). "</option>";}?>" +"</select>");
 $("#accountsrecp").html("<select id='incomeacctrecp'  name='incomeacctrecp'  style='width:250px;'>"+"<?php  foreach ($incomegls as $value) {
   echo "<option value='".$value['acno']."' >" . htmlspecialchars($value['acname']) . "</option>";
}?>" 
                +"</select>");
}
else{$("#chequedate").css("display","none"); $("#cheqno").css("display","none");$("#chequedetails").css("display","none");$("#chequedaterecp").css("display","none");$("#chequenorecp").css("display","none");$("#chequedetailsrecp").css("display","none")}
 }
 else{
...
//if bank deposit
    ...
    $("#banks").html("<select id='bankdeposit'  name='bankdeposit'  style='width:250px;'>"+ "<?php  foreach ($allbanks as $value) {
    echo "<option value='".$value['id']."' >" . htmlspecialchars($value['bank_name']). " : ".$value['property_name']."</option>";}?>" +"</select>");
...
else{$("#chequedate").css("display","none"); $("#cheqno").css("display","none");$("#chequedetails").css("display","none");$("#chequedaterecp").css("display","none");$("#chequenorecp").css("display","none");$("#chequedetailsrecp").css("display","none");$("#banks").css("display","none");}
}
});
...
$('#closedeposits').click(function(e){$('#depositlist').css("display","none");});
...
$('#closestatement').click(function(e){$('#tstmnt').css("display","none");});
...
$('#closeincomestatement').click(function(e){$('#incomestmnt').css("display","none");});
...
$('#closeacctlist').click(function(e){$('#acctlist').css("display","none");});
...
.done(function(data) {
        $("#suppitems").val(data.items);$("#saddress").val(data.address);$("#semail").val(data.email);$("#scity").val(data.city);$("#sphone").val(data.phone);
})
.fail(function() {
$(".validateTips4").html("<font size='2' color='red'><center>Error in fetching details</center></font>");
});
...
$('#closebill').click(function(e){$('#newsbill').css("display","none");
...
$('#closepbill').click(function(e){$('#paybill').css("display","none");
...
if ($("#paymodebill").val()==="1"||$("#paymodebill").val()==="2"){
    $("#paymode option[value='1']").attr("selected", "selected"); $("#paymode option[value='0']").attr("disabled","disabled");//cheque enabled
    $("#chequedate").css("display","block"); $("#cheqnobill").css("display","block");$("#chequedetails").css("display","block");$("#chequedetailsbill").css("display","block");$("#chequedetailslabel").css("display","block");$("#chequenotd").css("display","block");
...
//if payment mode is cash or bank deposit
    ...
    echo "<option value='".$value['id']."' >" . htmlspecialchars($value['bank_name']). "</option>";}?>" +"</select>");
    $("#chequedate").css("display","none"); $("#cheqnobill").css("display","none");$("#chequedetails").css("display","none");$("#chequedatebill").css("display","none");$("#chequenobill").css("display","none");$("#chequedetailsbill").css("display","none");$("#chequedetailslabel").css("display","none");$("#chequenotd").css("display","none");
    $("#paymode option[value='0']").attr("selected", "selected"); $("#paymode option[value='1']").attr("disabled","disabled");//autoselect payment mode
 $("#accountsbill").html("<select id='expenseacctbill'  name='expenseacctbill'  style='width:250px;'>"+ "<?php echo getexpenseaccount()?></select>");
}
else{$("#chequedate").css("display","none"); $("#cheqnobill").css("display","none");$("#chequedetails").css("display","none");$("#chequedaterecp").css("display","none");$("#chequenobill").css("display","none");$("#chequedetailsbill").css("display","none");$("#chequedetailslabel").css("display","none");$("#chequenotd").css("display","none");}
});
//load pending bills from supplier
var count;var amount=0; var billnum='';var sequencepay='';
$('#suppliernameselect').change(function(){
    $("#payamountbill").val(''); //emptyamount field
    $("#billnumbers").val(''); $("#sequencepayments").val('');//empty fields
    amount=0;billnum='';sequencepay='';
...
if($("#payperiod :selected").val()==""){alert('Select valid financial period');}
}else{
...
}else{/*open window for payment voucher list*/}
$('#newpbillform')[0].reset();
amount=0;billnum='';sequencepay='';
$("#pendingbills").empty();
})
...
$(".validateTips3").html("<font size='2' color='red'><center>Error in fetching details</center></font>");
 ...
 //payments list
$('#accountspayable').change(function(e){
if($("#accountspayable :selected").attr("id")=="paylist"){ $("#paymentslist").show('slow');}
...
$("#accountspayable").val('');
 ...
 $('#closepaylist').click(function(e){$('#paymentslist').css("display","none");});
...
if($("#payperiod :selected").val()==""){alert('Select valid financial period');}
    ...
    var post = $.get( "../modules/accountsprocess.php?paylandlord=true&property="+$('#propertytopay :selected').val()+"&amount="+$('#amountpaylandlord').val()+"&bank="+$('#banktopayfrom').val()+"&paydate="+$("#paymentdatelandlord").val()+"&chequedate="+$("#paymentdatecheque").val()+"&paymode=cheque"+"&chequeno="+$('#cheqnopay').val()+"&chequedetails="+$('#chequedetailspay').val(), function() {})
...
<legend id="suppliers"><h3><span style="color:red">ACCOUNTS PAYABLE |</span>&nbsp;Expenses/Suppliers | Other Clients</h3></legend>
...
<fieldset class="fieldsetcustomers">
    <legend id="customers"><h3>Tenants | Invoicing</h3></legend>
...
<fieldset class="fieldsetcustomers">
    <legend id="customers"><h3>Tenants | Receipting |Cash Movement</h3></legend>
...
<legend id="chartofaccounts"><h3>Chart of Accounts</h3></legend>
...
<?php }?>
<fieldset class="fieldsetchart">
<legend id="chartofaccounts"><h3>Statements</h3></legend>
...
<fieldset>
<table>  
<tr><td><label for="date">Billing  &nbsp;</label></td>
...
<tr><td><label for="usergroup">Tenant/Client Name &nbsp;</label></td>
...
<tr><td><label for="date">Entry Date &nbsp;</label></td>
...
<tr><td><label for="date">Water Consumption &nbsp;</label></td>
...
<tr><td><label for="incomeacct">Chargeable Items&nbsp;</label></td>
<td>
...
<input id="housevat" type="hidden" value="<?php echo $vatamount?>">
    <tr><td><label for="vat">VAT&nbsp;</label></td>
...
<br/><br/></td></tr> 
<tr hidden id="crdinv"><td><label for="invoiceno">Invoice No: &nbsp;</label></td>
<td><input id="invoiceno" name='invoiceno'    type="text" style="width:250px;">
<br/><br/></td></tr> 
<tr><td colspan="2"><div id="pendinginvoices"></div></td></tr>
<tr id="invnt"><td><input type="submit"  id="btnenewinvoice"  class="text ui-widget-content ui-corner-aEll" value="CREATE INVOICE" style="width:150px;font-weight:bold;"/></td><td></td><td><input type="submit" id="btnenextinvoice"  class="text ui-widget-content ui-corner-aEll" value="NEXT" style="width:50px;font-weight:bold;"/></td></tr>
<tr hidden id="crdnt"><td><input type="submit"  id="btnenewinvoice"  class="text ui-widget-content ui-corner-aEll" value="CREATE CREDIT NOTE" style="width:150px;font-weight:bold;"/></td><td></td><td><input type="submit" id="btnenextinvoice"  class="text ui-widget-content ui-corner-aEll" value="NEXT" style="width:50px;font-weight:bold;"/></td></tr>
</table>
</fieldset>
</form>
</div>
...
<fieldset>
<table>  
<tr><td><label for="amount">Invoice No. &nbsp;</label></td>
<td><input id="searchinvoice" type="text" name='searchinvoice'   style="width:70px; ">
</td><td><input type="submit" id="btnreverseinvoice"  class="text ui-widget-content ui-corner-aEll" value="SEARCH INVOICE" style="width:150px;font-weight:bold;"/></td></tr>  
...
<center><table>  
<tr><td><label for="inv">Invoice No. &nbsp;</label></td>
<td><input id="searchinvoiceprint" type="text" name='searchinvoiceprint'   style="width:100px; ">
</td><td><input type="submit" id="btnprintinvoice"  class="text ui-widget-content ui-corner-aEll" value="PRINT INVOICE" style="width:150px;font-weight:bold;"/></td></tr>  
</table></center>
</form>
</fieldset>
...
<fieldset>
<table>  
<tr><td><label>Start Date </label></td><td><label>End Date </label></td><td><label>Invoice For</label></td><td><label>Invoice Status</label></td></tr>
<tr><td><input id="startdatelist" type="text" name='startdatelist'   style="width:170px;"></td><td><input id="enddatelist" type="text" name='enddatelist' style="width:170px;"></td><td><select id='accnamelist'  name='accnamelist'  style="width:170px;"><option selected="selected" value="0">ALL</option><?php echo getincomeaccount() ?></select> </td><td><select id='invoicestatus'  name='invoicestatus'  style="width:170px;"><option selected="selected" value="%">ALL</option><option value="1">PAID</option><option value="0">NOT PAID</option></select> </td></tr>  
<tr><td><input type="radio"  name="single" value="0" checked="checked" >Single Property</td><td><input type="radio"  name="single" value="1"  >All Properties</td></tr>
<tr><td></td><td><input type="submit" id="btninvoicelist"  class="text ui-widget-content ui-corner-aEll" value="INVOICE LIST" style="width:150px;font-weight:bold;"/></td></tr>
</table>
</fieldset>
</form>
</div>
...
<fieldset>
<table>  
 <tr><td><label for="pname">Property Name. &nbsp;</label></td>
     <td><input id="propertyname" type="text" name='propertyname' value="<?php echo findpropertybyid($_SESSION['propertyid'])?>" readonly style="width:245px;background-color:lightyellow"></td></tr>
 <tr><td><label for="date">Billing  &nbsp;</label></td>
...
<tr><td><label for="datebatch">Entry Date &nbsp;</label></td>
...
<tr><td><label for="incomeacct"> Agent Income Account &nbsp;</label></td>
...
<br/><br/></td></tr> 
 <tr><td colspan="2"><center><input type="submit" id="btnbatchinvoice"  class="text ui-widget-content ui-corner-aEll" value="INVOICE BATCH" style="width:150px;font-weight:bold;"/></center></td></tr>
</table>
</fieldset>
</form>
</div>
...
<fieldset>
<table>  
    <tr><td><label for="addedit">Add/edit &nbsp;</label></td>
...
<tr><td><label id="cnamelabel" for="cname">Client Name &nbsp;</label></td>
<td id="cnametd"><input id="clientname" name='clientname'  style="width:245px; "/>
</td></tr> 
<tr><td><label for="cname">Physical Address &nbsp;</label></td>
<td><input id="caddress" name='caddress'  style="width:245px; "/>
</td></tr> 
<tr><td><label for="cname">Email Address &nbsp;</label></td>
<td><input id="cemail" name='cemail'  style="width:245px; "/>
</td></tr> 
<tr><td><label for="cname">City &nbsp;</label></td>
<td><input id="ccity" name='ccity'  style="width:245px; "/>
</td></tr> 
<tr><td><label for="cname">Client Phone &nbsp;</label></td>
<td><input id="cphone" name='cphone'  style="width:245px; "/>
</td></tr> 
<tr><td></td><td>&nbsp;&nbsp;&nbsp;<input type="submit" id="btncreateclient"  class="text ui-widget-content ui-corner-aEll" value="SAVE CLIENT" style="width:150px;font-weight:bold;"/></td></tr>
</table>
</fieldset>
</form>
</div>
...
<tr><td><label id="cnamelabel" for="cname">Expense/Supplier Name &nbsp;</label></td>
<td id="snametd"><input id="suppliername" name='suppliername'  style="width:245px; "/>
</td></tr> 
<tr><td><label for="cname">Expense/Supplied Items &nbsp;</label></td>
...
<tr><td><label for="cname"> Phone No&nbsp;</label></td>
<td><input id="sphone" name='sphone' value="n/a"  style="width:245px; "/>
</td></tr> 
<tr><td></td><td>&nbsp;&nbsp;&nbsp;<input type="submit" id="btncreatesupplier"  class="text ui-widget-content ui-corner-aEll" value="SAVE EXPENSE" style="width:150px;font-weight:bold;"/></td></tr>
</table>
</fieldset>
</form>
</div>
...
<table>  
    ...
    <tr><td><label for="usergroup"><input  id="tenantradio" type="radio" name="receivemoney" value="tenant" checked="checked">Tenant &nbsp;</label><label for="usergroup"><input id="othermoneyradio" type="radio" name="receivemoney" value="other">Receive Money &nbsp;</label></td><td><label for="cname">Receipt Date &nbsp;</label></td><td><label>&nbsp;&nbsp;No Penalty?</label></td></tr>
<tr><td><select id='tenantnamereceipt'  name='tenantnamereceipt'  style="width:250px;"><option selected="selected" value="">---</option>  
<?php findtenantbypropertyid($_SESSION['propertyid']) ?>
       </select>
...
//<?php findtenantbypropertyid($_SESSION['propertyid']) ?>
       ...
       </td><td>&nbsp;<input type="checkbox" id="penalize" value="1" checked="checked"></td></tr>
<tr><td><label for="usergroup">Financial Period &nbsp;</label></td>
...
<tr><td><label for="cname">Payment Mode &nbsp;</label></td><td><label for="cname">Amount</label></td></tr>
    <tr><td><select id="paymoderecp"  style="width:245px; height:20px; "><option selected="selected" value="">---</option><option value="0">CASH</option><option value="1">CHEQUE</option><option value="2">CREDIT CARD</option><option value="3">BANK DEPOSIT</option><option value="4">MPESA</option></select>
</td><td><input id="recpamount" name="recpamount" readonly style="width:245px; height:20px; border:1px solid green "/></td></tr> 
<tr><td><label id="chequedate" style="display:none;">Cheque Date &nbsp;</label></td><td><label id="cheqno" style="display:none;">Cheque No &nbsp;</label></td></tr>
<tr><td><input id="chequedaterecp"   style="width:245px; height:20px; display:none;"/>
</td><td><input id="chequenorecp"   style="width:245px; height:20px; display:none;"/>
</td></tr> 
<tr><td><label id="chequedetails" style="display:none;">Cheque Details &nbsp;</label></td><td><label for="remarks">Remarks &nbsp;</label></td></tr>
 <tr><td><textarea id="chequedetailsrecp"   style="width:245px; height:60px; text-wrap:normal;"></textarea>
</td><td><textarea id="remarksrecp"   style="width:245px; height:60px; text-wrap:normal;"></textarea>
</td></tr>
 <tr> <td><label for="banks">Bank&nbsp;</label></td><td id="banks"></td></tr>
 <tr> <td><label for="cname">To Account &nbsp;</label></td><td id="accountsrecp"></td></tr>
 <tr> <td><label for="cname">Penalty Account&nbsp;</label></td><td id="accountspenalty"></td></tr>
 <tr> <td><label for="reference">Transaction Reference&nbsp;</label></td><td><input type="text" class="required" id="transactionreference" placeholder="MPESA,BANK REF"></td></tr>
</table></center>
 <div id="recepdetails"></div></fieldset>
</fieldset>
</form>
</div>
<!--s-->
...
<center><table>  
<tr><td><label for="inv">Receipt No. &nbsp;</label></td>
<td><input id="searchreceiptprint" type="text"   style="width:100px; "/>
</td><td><input type="submit" id="btnprintreceipt"  class="text ui-widget-content ui-corner-aEll" value="PRINT RECEIPT" style="width:150px;font-weight:bold;"/>
<input type="submit" id="btnprintreceiptother"  class="text ui-widget-content ui-corner-aEll" value="MISC RECEIPT" style="width:150px;font-weight:bold;"/></td></tr>  
</table></center>
</form>
</fieldset>
...
<div id="reversepayment" class="displaynone" style="position:absolute;top:20px;left:350px;right:auto;z-index:9999 !important;background-color:whitesmoke;width:30%">
...
<fieldset>
<table>  
<tr><td><label for="recno">Bill No. &nbsp;</label></td>
<td><input id="searchpay" type="text"  style="width:70px; ">
</td><td><input type="submit" id="btnreversepayment"  class="text ui-widget-content ui-corner-aEll" value="REVERSE BILL" style="width:150px;font-weight:bold;"/></td></tr>  
...
<div id="reversepaymentexpense" class="displaynone" style="position:absolute;top:20px;left:350px;right:auto;z-index:9999 !important;background-color:whitesmoke;width:30%">
...
<fieldset>
<table>  
<tr><td><label for="recno">Voucher No. &nbsp;</label></td>
<td><input id="searchpayno" type="text"  style="width:70px; ">
</td><td><input type="submit" id="btnreversepaymentexpense"  class="text ui-widget-content ui-corner-aEll" value="REVERSE PAYMENT" style="width:150px;font-weight:bold;"/></td></tr>  
...
<fieldset>
<table>  
<tr><td><label for="recno">Receipt No. &nbsp;</label></td>
<td><input id="searchrecp" type="text"  style="width:70px; ">
</td><td><input type="submit" id="btnreversereceipt"  class="text ui-widget-content ui-corner-aEll" value="REVERSE RECEIPT" style="width:150px;font-weight:bold;"/><input type="submit" id="btnreverseotherreceipt"  class="text ui-widget-content ui-corner-aEll" value="OTHER RECEIPT" style="width:150px;font-weight:bold;"/></td></tr>  
...
<fieldset>
    <table width="100">  
        <tr><td><label><input type="radio" name="receiptsradio" value="rentreceipts" checked="checked" >Rent Receipts</label></td><td><label><input type="radio" name="receiptsradio" value="otherreceipts" >Other Receipts </label></td></tr>
<tr><td><label>Start Date </label></td><td><label>End Date </label></td></tr>
<tr><td><input id="startdaterecp"  style="width:150px;" type="text"  ></td><td><input id="enddaterecp" style="width:150px;" type="text" ></td></tr>  
<tr><td>Filter By tenant</td><td><select id="tenantfilter">
...
<tr><td><input type="radio"  name="receiptproperties" value="0" checked="checked" >Single Property</td><td><input type="radio"  name="receiptproperties" value="1"  >All Properties</td></tr>
<tr><td></td><td><input type="submit" id="btnrecplist"  class="text ui-widget-content ui-corner-aEll" value="RECEIPT LIST" style="width:150px;font-weight:bold;"/></td></tr>
</table>
</fieldset>
</form>
</div>
...
<fieldset>
    <table width="100">  
<tr><td><label>Start Date </label></td><td><label>End Date </label></td></tr>
<tr><td><input id="startdatedeposit" class="datepicker"  style="width:150px;" type="text"  ></td><td><input id="enddatedeposit" class="datepicker" style="width:150px;" type="text" ></td></tr>  
<tr><td><input type="radio"  name="depositproperties" value="0" checked="checked" >Single Property</td><td><input type="radio"  name="depositproperties" value="1"  >All Properties</td></tr>
<tr><td></td><td><input type="submit" id="btndepositlist"  class="text ui-widget-content ui-corner-aEll" value="DEPOSIT LIST" style="width:150px;font-weight:bold;"/></td></tr>
</table>
</fieldset>
</form>
</div>
...
<fieldset>
<table>  
    <tr><td>Mode:</td><td style="color:black;"><input type="radio"  name="clients" value="0">Single Tenant
                                <input type="radio" name="clients" value="1">All Tenants
    </td></tr>
  <tr><td><br></td></tr>
<tr><td><label for="usergroup">Tenant Name &nbsp;</label></td>
...
<tr><td><label for="cname">From Date &nbsp;</label></td><td><label for="cname">To Date</label></td></tr>
    <tr><td><input id="fromdate" name="fromdate" readonly style="width:200px; height:20px; border:1px solid green "/>
        </td><td><input id="todate" name="todate" readonly style="width:200px; height:20px; border:1px solid green "/></td></tr>
    <tr><td><br><br></td></tr>
<tr><td></td><td><input type="submit" id="btnfetchstatement"  class="text ui-widget-content ui-corner-aEll" value="VIEW STATEMENT" style="width:150px;font-weight:bold;"/></td></tr>
</table></center>
</fieldset>
</form>
</div><!--tenant statement's--
...
<fieldset>
<table>  
     <tr><td>Report:</td><td style="color:black;"><input type="radio"  name="arrearsorprepayment" value="A">Arrears
                                <input type="radio" name="arrearsorprepayment" value="P">Prepayments
    </td></tr>
    <tr><td>Mode:</td><td style="color:black;"><input type="radio"  name="clients1" value="0">Single Tenant
...
<tr><td><label>Arrears To:</label>
            ...
            <br>
            <input id="todatearrears" placeholder="To Date" class="datepicker" name="todate" readonly style="width:200px; height:20px; border:1px solid green "/></td></tr>
    <tr><td><br><br></td></tr>
<tr><td></td><td><input type="submit" id="btnfetcharrearsprep"  class="text ui-widget-content ui-corner-aEll" value="VIEW REPORT" style="width:150px;font-weight:bold;"/></td></tr>
</table></center>
</fieldset>
</form>
...
<table>  
    ...
    <tr><td>Mode:</td><td style="color:black;"><input type="radio"  name="penaltyradio" value="0">Single Tenant
...
<tr><td><label>Penalties To:</label>
        </td><td><input id="todatepenalty" class="datepicker" name="todate" readonly style="width:200px; height:20px; border:1px solid green "/></td></tr>
    <tr><td><br><br></td></tr>
    <tr><td></td><td>&nbsp;&nbsp;<input type="submit" id="btnfetchpenalty"  class="text ui-widget-content ui-corner-aEll" value="VIEW REPORT" style="width:150px;font-weight:bold;"/></td></tr>
</table>
</fieldset>
</form>
</div>
...
<table>  
  ...
  <tr><td><br></td></tr>
  <tr><td colspan="2"><label for="usergroup">Income Statement &nbsp;</label></td>
</tr> 
<tr><td><label for="cname">From Date &nbsp;</label></td><td><label for="cname">To Date</label></td></tr>
    <tr><td><input id="fromdateinc" name="fromdateinc" readonly style="width:200px; height:20px; border:1px solid green "/>
        </td><td><input id="todateinc" name="todateinc" readonly style="width:200px; height:20px; border:1px solid green "/></td></tr>
    <tr><td><br><br></td></tr>
<tr><td></td><td><input type="submit" id="btnfetchincstatement"  class="text ui-widget-content ui-corner-aEll" value="VIEW STATEMENT" style="width:150px;font-weight:bold;"/></td></tr>
</table></center>
</fieldset>
</form>
...
<fieldset> <center>
<table>  
    <tr><td><input type="radio"  name="expensetype" class="blackfont expensetype" checked="checked" value="1"><span class="blackfont">Property Expense</span></td><td><input type="radio"  name="expensetype" class="expensetype"  value="0"><span class="blackfont">Office Expense</span></td></tr>
<tr><td><label for="usergroup">Expense/Supplier Name &nbsp;</label></td><td><label for="cname">Billing Date &nbsp;</label></td></tr>
<tr><td class="expenseentry"><select id='supplliername'  name='supplliername'  style="width:250px;"><option selected="selected" value="">Select Expense Ledger</option>  
<?php
...
<tr><td><label for="cname">Expense =====>&nbsp;</label></td><td><input id="supplieditems" type="text"  name="supplieditems" style="width:245px; height:20px;"/></td></tr>
<tr><td><label>Financial Period</label></td><td id="expenseperioddiv">
...
<tr><td><label for="cname">Total Amount owed=====> &nbsp;</label></td><td><input id="owedamount" type="text" name="owedamount" style="width:245px; height:20px;"/></td></tr>
<tr><td><label for="usergroup">Charge Fee As Income (%) &nbsp;</label></td><td><input id="feepercent" type="text"  name="feepercent" style="width:105px; height:20px;"/><input id="totalcharges" type="text"  name="totalcharges" placeholder="totalamount" style="width:105px; height:20px;border:1px solid green"/></td></tr>
<tr><td><label for="usergroup">Income Account &nbsp;</label></td><td>
...
<tr><td><label for="remarks">Remarks (Expense Details)&nbsp;</label></td>
<td><textarea id="billremarks" name='billremarks'   style="width:245px; height:100px; text-wrap:normal;"></textarea>
<br/><br/></td></tr> 
<tr><td><br></td></tr>
<tr><td colspan="2"><center><input type="submit" id="btnreceivebill"  class="text ui-widget-content ui-corner-aEll" value="CREATE EXPENSE ENTRY" style="width:250px; height:60px;font-weight:bold;"/></center>></td></tr>
</table></center>
 </fieldset>
...
<fieldset> <center>
<table>  
<tr><td><label for="usergroup">Expense/Supplier Name &nbsp;</label></td><td><label for="cname">Payment Date &nbsp;</label></td></tr>
<tr><td><select id='suppliernameselect'  name='suppliernameselect'  style="width:250px;"><option selected="selected" value="">Select Expense/Supplier</option>  
<?php
$propid=$_SESSION['propertyid'];
 $glaccountexp=  getLandlordExpenseAccounts(array('gl'=>'LandlordExpense','property_id'=>$propid));
 foreach ( $glaccountexp as $expenseacct) {
...
<tr><td><label>Financial Period</label></td><td id="payperioddiv">
...
<tr><td><label for="cname">Payment Mode &nbsp;</label></td><td><label for="cname">Total Amount</label></td></tr>
    <tr><td><select id="paymodebill"  style="width:245px; height:20px; "><option selected="selected" value="">---</option><option value="0">CASH</option><option value="1">CHEQUE</option><option value="2">CREDIT CARD</option><option value="3">BANK DEPOSIT</option><option value="4">MPESA</option></select>
        </td><td><input id="payamountbill" type="text" name="payamountbill" readonly="true"style="width:245px; height:20px; border:1px solid green "/></td></tr> 
    <input type="hidden" id="sequencepayments"/><input type="hidden" id="billnos"/>
    <tr><td style="color:grey;font-weight:bold">Chequedate =========> </td><td><input id="chequedatebill" type="text" name="chequedatebill" readonly="true"style="width:245px; height:20px; border:1px solid green "/></td></tr> 
    <tr><td><label id="chequedate" style="display:none;">Cheque Date &nbsp;</label></td><td><label id="cheqno" style="display:none;">Cheque No &nbsp;</label></td></tr>
<tr><td  id="chequenotd" style="color:grey;font-weight:bold;display:none;">CHEQUE NO ====></td><td><input id="cheqnobill"   style="width:245px; height:20px; display:none;"/>
</td></tr> 

<tr><td><label id="chequedetailslabel" style="display:none;">Cheque Details &nbsp;</label></td><td><label for="remarks">Remarks &nbsp;</label></td></tr>
 <tr><td><textarea id="chequedetailsbill"   style="width:245px; height:60px; text-wrap:normal;"></textarea>
</td><td><textarea id="remarksbill"   style="width:245px; height:60px; text-wrap:normal;"></textarea>
</td></tr>
 <tr> <td><label for="cname">Expense Account ========> &nbsp;</label></td><td>
 ...
 <tr> <td><label for="cname">Cash Account=======> &nbsp;</label></td><td id="paybillbanks"></td></tr>
 <tr> <td colspan="2"><div id="pendingbills"></div></td></tr>
 <tr><td colspan="2"><center><input type="submit" id="btnpaybill"  class="text ui-widget-content ui-corner-aEll" value="PAY BILL" style="width:200px;height:30px;font-weight:bold;"/></center></td></tr>
</table></center>
 </fieldset>
...
<form id="depositrefundform" method="post" enctype="multipart/form-data" >
    <tr><td><label>Tenant </label></td><td><select id='tenantnamedeposit'  name='tenantnamedeposit'  style="width:100%;">
<option selected="selected" value="">---</option>  
<?php findtenantbypropertyid($_SESSION['propertyid']) ?>
       </select></td></tr>
    <tr><td  colspan="2"></td></tr>
    <tr><td><label>Deposit</label></td><td id="tenantdepositdiv">            
        </td></tr>
    <tr><td><label>Refund date</label></td><td><input type="text" id="depositrefunddate" style="width:90%;" class="datepicker"> </td></tr>
    <tr><td><label>Payment Mode</label></td><td><select id="paymoderefund"  style="width:90%; height:20px; "><option selected="selected" value="">---</option><option value="0">CASH</option><option value="1">CHEQUE</option><option value="2">CREDIT CARD</option><option value="3">BANK DEPOSIT</option><option value="4">MPESA</option></select></td></tr>
     <tr><td><label>Cheque date</label></td><td><input type="text" id="chequedatedeposits" style="width:90%;" class="datepicker"> </td></tr> 
     <tr><td><label>Cheque No</label></td><td><input type="text" id="chequenorefund" style="width:90%;"> </td></tr> 
     <tr><td><label>Cheque Details</label></td><td><textarea id="chequedetailsdeposit"   style="width:250px; height:60px; text-wrap:normal;"></textarea></td></tr>
      <tr><td><label>Remarks</label></td><td><textarea id="refundremarks"   style="width:250px; height:60px; text-wrap:normal;"></textarea></td></tr>
<tr><td colspan="2"><center><input type="submit" id="btnrefunddeposit"  class="text ui-widget-content ui-corner-aEll" value="REFUND DEPOSIT" style="width:200px;height:30px;font-weight:bold;"/></center></td></tr>
</form>
    </table>
</div>
...
<fieldset>
<table>  
<tr><td><input type="radio"  name="expenselist" class="blackfont expenselist" checked="checked" value="0"><span class="blackfont">Property Expense</span></td><td><input type="radio"  name="expenselist" class="blackfont expenselist"  value="2"><span class="blackfont">All Properties</span></td><td><input type="radio"  name="expenselist" class="expenselist"  value="1"><span class="blackfont">Office Expense</span></td></tr>
<tr><td>Expense</td><td><select name="expenseacct" id="expenseaccountsupplier">
...
<tr><td><label for="cname">From Date &nbsp;</label></td><td><label for="cname">To Date</label></td></tr>
<tr id="fromtopay"><td><input id="fromdatepay" name="fromdatepay" readonly style="width:200px; height:20px; border:1px solid green "/>
        </td><td><input id="todatepay" name="todatepay" readonly style="width:200px; height:20px; border:1px solid green "/></td></tr>
    <tr><td>Use Financial Periods Instead?</td><td><input type="checkbox" id="usefperiodspay" value="1" /></td></tr>
    <tr><td style="display:none">Financial Year</td><td style="display:none">
    ...
    <tr><td>Close Period(Month)</td><td id="closeperiodpayments">
                   
            </td></tr>
    <tr><td colspan="2"><center><input type="submit" id="btnpaymentlist"  class="text ui-widget-content ui-corner-aEll" value="VIEW PAYMENTS LIST" style="width:250px;height:30px;font-weight:bold;"/></center></td></tr>
</table></fieldset>
</form>
</div><!--payments list
...
<table>  
<tr><td><label for="amount">Landlord/Property Name. &nbsp;</label></td>
...
<tr><td>Payment Source</td><td><select id='banktopayfrom'  name='bankdepositpay'  style='width:250px;'><option value='0' selected='selected'>Select Bank Account</option>
    <?php 
...
<tr><td>Payment Date</td><td><input id="paymentdatelandlord" class="datepicker" name="paymentdatelandlord" readonly placeholder="todate" value="<?=date("d-m-Y")?>"  style="height:20px; border:1px solid green "/></td></tr>  
<tr><td><label id="chequedate" >Cheque Date &nbsp;</label></td><td><input id="paymentdatecheque" class="datepicker" name="paymentdatecheque"  placeholder="todate" value="<?=date("d-m-Y")?>"  style="height:20px; border:1px solid green "/></td></tr>
<tr><td  id="chequenotd" style="color:grey;font-weight:bold;">CHEQUE NO ====></td><td><input id="cheqnopay"   style="width:245px; height:20px;"/>
</td></tr> 
<tr><td><label id="chequedetailslabel">Cheque Details &nbsp;</label></td><td><textarea id="chequedetailspay"   style="width:245px; height:60px; text-wrap:normal;"></textarea></td></tr>

<tr><td></td><td><br></td></tr>  
<tr><td></td><td><input type="submit" id="btnpaylandlord"  class="text ui-widget-content ui-corner-aEll" value="PROCESS PAYMENT" style="width:160px;font-weight:bold;"/></td></tr>  
